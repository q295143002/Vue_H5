  ...
  <div class="gx-body">
    <div class="gx-b-block1">
      <flexbox>
        <flexbox-item :span="7/12">
          ...
          <br>
          <span class="gx-bb gx-bb-2 margin-1">{{bodyData.ApprovalName}}</span>
        </flexbox-item>
      ...
      <flexbox>
        <flexbox-item :span="7/12">
          <span class="gx-bb gx-bb-1 color999">审批截止时间</span>
          <br>
        ...
        <flexbox-item :span="5/12">
          ...
          <br>
          <span class="gx-bb gx-bb-2 colorf90 margin-1">
    ...
    <div class="gx-b-block2" v-for="item in bodyData.fltInfo">
      <p class="title font-8">
        ...
        <a href="" class="cell_air_href">查看订单详情&gt;</a>
      </p>
      <flexbox>
      ...
      <div>
        <x-timeline>
          <x-timeline-item v-for="item in bodyData.ApprovalLogList" >
            <h4 class='line-word-1' >{{item.Name}} <span class="timeline_states">通过</span></h4>
            <p class='line-word-2' >备注：{{item.Remark}}</p>
